class Cylinder{
    ...
    generateVertices(){
      ...
      for(var angle = 0; angle < 360; angle += angleStep){ //there is a rounding error for when number of segments == 7 (fixed by making less than 361 shouldnt be a problem as long as seg size > 360
        ...
        v.push(orig[0],orig[1],1, 0,0,    vtx1[0],vtx1[1],1, 0,0,    vtx2[0],vtx2[1],1, 0,0);

        v.push(vtx1[0],vtx1[1],0, 0,0,    vtx1[0],vtx1[1],1, 0,0,    vtx2[0],vtx2[1],1, 0,0);
        v.push(vtx2[0],vtx2[1],1, 0,0,    vtx2[0],vtx2[1],0, 0,0,    vtx1[0],vtx1[1],0, 0,0);
